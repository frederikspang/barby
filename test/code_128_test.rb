...
describe Barby::Code128 do
  ...
  describe "Function characters" do
    ...
    it "should keep the special symbols as characters" do
      expect(Barby::Code128A.new(binary_encode("\301ABC\301DEF")).characters).must_equal binary_encode_array(%W[\301 A B C \301 D E F])
      expect(Barby::Code128B.new(binary_encode("\301ABC\302DEF")).characters).must_equal binary_encode_array(%W[\301 A B C \302 D E F])
      expect(Barby::Code128C.new(binary_encode("\301123456")).characters).must_equal binary_encode_array(%W[\301 12 34 56])
      expect(Barby::Code128C.new(binary_encode("12\30134\30156")).characters).must_equal binary_encode_array(%W[12 \301 34 \301 56])
    end
  ...
  describe "Code128 automatic charset" do
    ...
    it "should know how to extract CODEC segments properly from a data string" do
      expect(Barby::Code128.send(:extract_codec, "1234abcd5678\r\n\r\n")).must_equal ["1234", "abcd", "5678", "\r\n\r\n"]
      expect(Barby::Code128.send(:extract_codec, "12345abc6")).must_equal ["1234", "5abc6"]
      expect(Barby::Code128.send(:extract_codec, "abcdef")).must_equal ["abcdef"]
      expect(Barby::Code128.send(:extract_codec, "123abcdef45678")).must_equal ["123abcdef4", "5678"]
      expect(Barby::Code128.send(:extract_codec, "abcd12345")).must_equal ["abcd1", "2345"]
      expect(Barby::Code128.send(:extract_codec, "abcd12345efg")).must_equal ["abcd1", "2345", "efg"]
      expect(Barby::Code128.send(:extract_codec, "12345")).must_equal ["1234", "5"]
      expect(Barby::Code128.send(:extract_codec, "12345abc")).must_equal ["1234", "5abc"]
      expect(Barby::Code128.send(:extract_codec, "abcdef1234567")).must_equal ["abcdef1", "234567"]
    end
