...
module Barby
  ...
  class EAN13 < Barcode1D
    ...
    LEFT_PARITY_MAPS = {
      0 => %i[odd odd odd odd odd odd], # UPC-A
      1 => %i[odd odd even odd even even],
      2 => %i[odd odd even even odd even],
      3 => %i[odd odd even even even odd],
      4 => %i[odd even odd odd even even],
      5 => %i[odd even even odd odd even],
      6 => %i[odd even even even odd odd],
      7 => %i[odd even odd even odd even],
      8 => %i[odd even odd even even odd],
      9 => %i[odd even even odd even odd]
    }
